    ...
    <div class="container">
      <div class="row">
        <div class="col l6 s12">
          ...
          <p class="grey-text text-lighten-4"><a class="orange-text text-lighten-3" href="#"> Abhijeet </a> is a student of <a class="orange-text text-lighten-3" href="http://www.iitb.ac.in/"> IIT Bombay </a> working on this project. Any amount of help would support this project and is greatly appreciated.</p>
        </div>
